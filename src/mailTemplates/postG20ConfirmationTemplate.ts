const PostG20ConfirmationTemplate = function (name: string, code: string, qrCodeUrl: string) {
  return `
<html lang="en">
  <head>
    <meta charset="UTF-8" />
      ...
      <tr>
        ...
        >
          <p style="font-weight: 700; font-size: 28px; line-height: 28px; color: #fff; text-align: center">
            <span style="font-weight: 700; font-size: 20px; font-style: italic">Welcome to</span> <br />
            House of Greats 2026 Parliament.
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding: 40px; line-height: 26px; font-size: 16 px; color: #253858; font-style: normal; font-weight: 400">
          <p>Hi ${name},</p>
          <p>Welcome to the House of Greats Parliament!</p>
          <p>
            We are honored to officially welcome you into this life-transforming journey of Partnering with the Prophet of God to take the Gospel to the nations
            of the earth.
          </p>
          <p>
            As a member of this great house, remember… your commitment carries deep purpose. It’s more than a giving; it’s a prophetic step toward changing lives and expanding the Kingdom of God across the globe.
          </p>

          <p>🔑 Below is your personal HOG Code:</p>
          <div class="button" style="width: 70%; margin: 10px auto">
            <div
              style="
          ...
          <p>
            Please keep this handy, as it helps us serve you better and ensures smoother engagement with the HOG team. You can also present the QR code below to be enrolled in to the partner's meeting.
          </p>
      ...
      <tr>
        <td style="text-align: center; padding: 24px 40px; line-height: 32px">
          <p style="padding: 0px; color: #253858; font-style: normal; font-weight: 400">
            Warmest Regards, <br />
            <span style="font-weight: bold">HOG 2025 Team</span>
          </p>
...
export default PostG20ConfirmationTemplate;
