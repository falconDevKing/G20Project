const PauseSubscriptionTemplate = function ({
  userName,
  chapterName,
  divisionName,
  toolsUrl,
      ...
      <tr>
        <td>
          <p style="font-weight: 700; line-height: 28px; color: #84693c; text-align: center; padding-top: 24px">
            <span style="font-weight: 700; font-size: 2rem">SUBSCRIPTION PAUSE REQUEST</span>
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding: 40px 40px 20px; line-height: 24px; font-size: 16px; color: #253858; font-style: normal; font-weight: 400">
          ...
          <p>This is a notification that ${userName} from ${chapterName}, ${divisionName} has requested a pause in their subscription with the following reason.</p>

          <p>Reason: ${reason}</p>

          <p>Help reach out to them to get more context, and when the subscription is to be paused, kindly navagate to ${toolsUrl} to pause the subscription.</p>
...
export default PauseSubscriptionTemplate;
