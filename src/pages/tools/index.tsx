    ...
    <ContainerFluid>
      <div className="py-6">
        <div>
          ...
          <p className="max-w-[530px] font-light text-base dark:text-white text-GGP-dark/75  mb-6" >
            Access extra tools to make functions easier
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tools.map((tool) => {
            ...
            return tool.href ? (<Link key={tool.href} to={tool.href} className="block">
              <Card className={cn(
