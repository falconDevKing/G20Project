    ...
    <div className="min-h-screen bg-GGP-dark text-GGP-lightWight flex justify-center px-4 py-10">
      <div className="w-full max-w-3xl bg-GGP-lightWight text-GGP-dark rounded-2xl shadow-lg border border-GGP-darkGold overflow-hidden">
        ...
        <div className="px-6 py-6 space-y-4 text-sm md:text-base leading-relaxed max-h-[70vh] overflow-y-auto">
          <p>
            In line with data protection requirements and platform policies,
            Global Gospel Partnership (GGP) provides a clear way for you to
            request deletion of your personal data from the GGP App.
          </p>

          <h3 className="text-md font-semibold text-GGP-darkGold">
            How to request deletion of your data
          </h3>
          <div>You can request deletion of your data by sending an email to <span className="font-medium">info@globalgospelpartnership.org</span> with the subject line <span className="italic font-medium">“Data Deletion Request”</span> and include:
          ...
          <li>
            ...
            Send an email to{" "}
            <span className="font-medium">info@globalgospelpartnership.org</span>{" "}
          ...
          <h3 className="text-md font-semibold text-GGP-darkGold mt-4">
            What happens when you request deletion?
          </h3>
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>
              We will verify your identity using the information you provide.
            </li>
            <li>
              Your GGP account will be scheduled for deletion and removed from active use.
            </li>
            <li>
              Personal data associated with your account will be deleted or anonymised,
              except for information we are required to retain for legal, accounting, or
              regulatory reasons (for example, certain financial records).
            </li>
            <li>
              We will confirm by email once your request has been processed.
            </li>
          </ul>

          <p className="mt-4 text-sm">
            If you have any questions about how we handle your data, please see our{" "}
            <span className="font-medium">Privacy Policy</span> or contact us at{" "}
            <span className="font-medium">info@globalgospelpartnership.org</span>.
          </p>
        </div>
