...
import { CarouselOverlay } from "./g20CarouselOverlay";
import { cn } from "@/lib/utils";
import { Link } from "react-router-dom";

interface G20CardWrapperProps {
  children: ReactNode;
  headerLabel: string;
...
export const G20CardWrapper = ({
  ...
  return (
    <section className=" min-h-screen w-full flex flex-col lg:flex-row relative bg-[#1E1E1E]">
      ...
      >
        <Card className="rounded-lg bg-white w-full max-w-md sm:max-w-lg md:max-w-[640px] max-h-full md:max-h-[80vh] overflow-auto my-12 lg:my-0">
          <CardHeader>
            ...
            <div className="font-bold text-center">
              <Header lable={headerLabel} position="center" />
            </div>
          </CardHeader>
