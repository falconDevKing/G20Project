...
const carouselItems = [
  {
    captionText: "Welcome to House of Greats (HOG)",
    subCaptionText:
  ...
  {
    captionText: "Provide humanitarian relief and long-term solutions to communities in need.",
    pictureStyle: "fill",
    ...
    <div className="relative w-full h-full overflow-y-hidden">
      ...
      <div className="overflow-hidden w-full h-full" ref={emblaRef}>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex gap-4 z-20">
          <button
            onClick={scrollPrev}
            className="w-14 h-14 rounded-full bg-transparent border flex items-center dark:border-white/50 justify-center text-white hover:bg-GGP-darkGold/50"
          >
            <ArrowLeft size={20} />
          </button>
          <button
