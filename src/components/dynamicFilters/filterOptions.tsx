...
export const filterFieldsOptions = [
  ...
  { label: "Shepherd", value: "shepherd_id", filterType: ["Partner", "Payment", "Proposed"], allow: ["Admin"] },
  { label: "Governor", value: "governor_id", filterType: ["Partner", "Payment", "Proposed"], allow: ["Admin"] },
  { label: "President", value: "president_id", filterType: ["Partner", "Payment", "Proposed"], allow: ["Admin"] },
