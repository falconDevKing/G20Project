...
import { onlineMonthlyPaymentFormSchema } from "@/lib/schemas";
...
interface MakeOnlineMonthlyPaymentProps {
  filterData?: () => void;
...
export const MakeOnlineMonthlyPayment = ({ filterData, handleBankPopupClosed }: MakeOnlineMonthlyPaymentProps) => {
  ...
  const form = useForm<OnlineMonthlyPaymentFormValues>({
    resolver: zodResolver(onlineMonthlyPaymentFormSchema),
    defaultValues: {
