    ...
    <div>
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        ...
        <DialogContent className="max-w-xl">
          <h2 className="md:text-xl  font-semibold mb-4">Add New Remission Record</h2>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div>
                        ...
                        <FormControl>
                          <div className="flex rounded-md border border-gray-500/20 items-center px-2">
                            ...
                            <DatePicker
                              ...
                              className="border-0 outline-none  w-full py-4"
                ...
                <div className="hidden bg-GGP-lightWight dark:bg-input/15 p-3  space-y-7 rounded-md my-1">
                  <FormField
                    control={form.control}
                    name="is_converted"
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border py-1 px-3 shadow-sm m-1">
                        <div className="space-y-0.5">
                          <FormLabel className="">Currency Conversion</FormLabel>
