...
export const FileUpload = ({ user_id, filePath, onChange }: FileUploadProps) => {
  ...
  return (
    <div {...getRootProps()} className="file-upload relative cursor-pointer flex flex-col items-center">
      ...
      {/* Box Background */}
      <div className="p-2 md:p-3 lg:p-6 w-full bg-GGP-lightWight rounded-lg flex items-center justify-center">
