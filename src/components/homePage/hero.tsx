...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden px-4 sm:px-6 lg:px-10">
      ...
      <div className="relative mx-auto max-w-7xl py-10 sm:py-12 lg:py-14">
        <div className="mx-auto grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-10">
          <div>
