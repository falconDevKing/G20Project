...
const TabletHero = () => {
  ...
  useEffect(() => {
    const imageRotationInterval = window.setInterval(() => {
      // setActiveImageIndex(() => Math.floor(Math.random() * TabletheroImages.length));
  ...
  return (
    <div className="relative overflow-hidden hidden lg:block xl:hidden bg-red-500">
      ...
      <div className="relative mx-auto  py-10 sm:py-12 lg:py-14">
        <div className="mx-auto grid grid-cols-1 items-center gap-8 xl:grid-cols-2 lg:gap-10 max-w-4xl">
          <div>
            ...
            <p className="mt-5 w-full xl:max-w-xl text-base leading-7 text-[#d3ddf1] sm:text-lg text-justify">
            ...
            <div className="flex flex-row my-6 gap-4">
              <div className="hidden sm:flex flex-col justify-evenly m-6 gap-6 basis-2/5">
                <div className="rounded-full border border-[#3c4863] bg-[#1a2945] px-4 py-2 text-sm text-[#d8e2f7] text-center">
                  Minimum annual commitment: <span className="font-semibold text-[#f0cf86]">{bronzeMinimumValue}</span>
                </div>
                <div className="rounded-full border border-[#3c4863] bg-[#1a2945] px-4 py-2 text-sm text-[#d8e2f7] text-center">Conviction-led Partnership</div>
              ...
              <div className="relative rounded-3xl border border-[#2f3c57] bg-[#111c31] p-5  sm:p-6 lg:p-8 lg:pt-0 basis-3/5">
                ...
                <div className="mt-6 rounded-2xl border border-[#34415b] bg-[#1b2842] p-4 sm:p-5 text-center">
                  <p className="text-md italic text-[#f0cf86]">"These also are the chief of the mighty men whom David had..."</p>
                  <p className="mt-2 text-sm font-semibold text-[#b9c8e7]">1 Chronicles 11:10</p>
                </div>
              </div>
            </div>

            <div className="hidden my-6 gap-6">
          ...
          <div className="relative mx-auto w-full max-w-md hidden xl:block">
