...
const Faqs = () => {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      a: `G20 partnership is structured in annual categories, beginning from ${bronzeMinimumValue} per year, so you can choose a level that matches your capacity and conviction.`,
    },
    {
