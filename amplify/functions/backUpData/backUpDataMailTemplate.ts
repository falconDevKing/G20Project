const BackUpDataMailTemplate = (baseUrl: string) => {
  return `
<html lang="en">
  <head>
    <meta charset="UTF-8" />
      ...
      <tr>
        <td>
          <p style="font-weight: 700; line-height: 28px; color: #84693c; text-align: center; padding-top: 24px">
            <span style="font-weight: 700; font-size: 2rem">🎉 BACKUP COMPLETE</span>
          </p>
        </td>
      </tr>
      <tr>
        <div style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 1.6; color: #111827">
          ...
          <p style="margin: 0 0 12px">The database backup was completed successfully for ${baseUrl}.</p>

          <p style="margin: 16px 0 0; color: #6b7280; font-size: 12px">This is an automated notification. Please do not reply to this email.</p>
        </div>
      </tr>
...
export default BackUpDataMailTemplate;
