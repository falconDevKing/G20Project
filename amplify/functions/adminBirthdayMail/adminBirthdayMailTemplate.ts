...
const AdminBirthdayMailTemplate = function (birthdayData: BirthdayData[]) {
  return `<html lang="en">
  <head>
    <meta charset="UTF-8" />
      ...
      <tr>
        <td>
          <p style="font-weight: 700; line-height: 28px; color: #84693c; text-align: center; padding-top: 24px">
            <span style="font-weight: 700; font-size: 2rem">🎉 BIRTHDAY ALERT</span>
          </p>

          <div style="font-weight: 700; line-height: 28px; text-align: center">
            <span style="font-weight: 700; font-size: 1.2rem; text-align: center">Partners Under Your Care</span>
          </div>
        </td>
      </tr>
      <tr>
        <td style="padding: 40px 40px 20px; line-height: 24px; font-size: 16px; color: #253858; font-style: normal; font-weight: 400; text-align: center">
          <p>Hello,</p>

          <p>A gentle reminder: the following individuals under your care are celebrating their birthdays this week:</p>

          <ul style="padding-left: 20px; margin: 10px 0">
            ${birthdayData
              .map(({ name, phoneNumber, dateofBirth }) => {
                return "<li><strong>" + name + "</strong> — " + dateofBirth + " | 📞 " + phoneNumber + "</li>";
              })
              .join(" ")}
          </ul>

          <p>We encourage you to reach out with a prayer, a call, or a kind word as we celebrate them.</p>

          <p>Thank you for supporting excellence and integrity in our stewardship.</p>
        </td>
      </tr>
...
export default AdminBirthdayMailTemplate;
