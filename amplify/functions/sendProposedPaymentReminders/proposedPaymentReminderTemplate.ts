const ProposedPaymentReminderTemplate = ({
  firstName,
  proposedDate,
  proposedAmount,
  currency,
...
<html lang="en">
  ...
  <body style="margin: 0; padding: 0; background-color: #ffffff">
    ...
    >
      ...
      <tr>
        <td>
          <p style="font-weight: 700; font-size: 28px; line-height: 34px; color: #84693c; text-align: center; padding-top: 24px; margin: 0">
            Your G20 Proposed Payment Reminder
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding: 40px; line-height: 26px; font-size: 1.25rem; color: #253858; font-style: normal; font-weight: 400; text-align: center">
          <p>Hi ${firstName || "Honourable"},</p>

          <p>
            This is a gentle reminder that your proposed G20 payment of
            <strong>${amountLabel}</strong> is due in <strong>${daysRemaining} ${dayLabel}</strong>.
          </p>

          <p>
            We encourage you to make plans to fulfil this commitment on or before the scheduled date as part of your continued partnership and support for the
            vision.
          </p>

          <p>Below is a summary of your proposed payment.</p>
        </td>
      </tr>

      <tr>
        <td style="padding: 0px 40px; line-height: 32px; color: #253858; font-style: normal; font-weight: 400">
          <div class="summary-card" style="margin: 20px; padding: 20px; font-weight: 500; border: 1px solid #e6e8f0; border-radius: 8px; line-height: 21px">
            <div style="text-align: center; font-weight: 600; padding: 20px; font-size: 18px">Proposed Payment Details</div>

            <div style="padding: 20px">
              <div class="summary-row" style="display: flex; color: #8083a3; font-size: 1.25rem; line-height: 21px; padding: 8px 0px">
                <div style="width: 30%">Amount</div>
                <div style="width: 70%; text-align: right; font-size: 1.5rem; color: black; font-weight: 600">${amountLabel}</div>
              </div>

              <div class="summary-row" style="display: flex; color: #8083a3; font-size: 1.25rem; line-height: 21px; padding: 8px 0px">
                <div style="width: 30%">Proposed Date</div>
                <div style="width: 70%; text-align: right; font-size: 1.5rem; color: black">${proposedDate}</div>
              </div>

              <div class="summary-row" style="display: flex; color: #8083a3; font-size: 1.25rem; line-height: 21px; padding: 8px 0px">
                <div style="width: 30%">Time Remaining</div>
                <div style="width: 70%; text-align: right; font-size: 1.5rem; color: black">${daysRemaining} ${dayLabel}</div>
              </div>
            </div>

            <div class="cta-wrap" style="margin: 0px auto; width: 50%; padding: 40px 0px; text-align: center">
              <a
                href="${dashboardUrl}"
                style="
                  padding: 12px 36px;
          ...
          <p style="text-align: center">Thank you for your faithfulness and continued commitment to the work. Your partnership remains greatly valued.</p>
        </td>
      </tr>
...
export default ProposedPaymentReminderTemplate;
