  ...
  public: {
    Tables: {
      ...
      paystack_pending_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "paystack_pending_payments_chapter_id_fkey"
            columns: ["chapter_id"]
            isOneToOne: false
            referencedRelation: "chapter"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "paystack_pending_payments_division_id_fkey"
            columns: ["division_id"]
            isOneToOne: false
            referencedRelation: "division"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "paystack_pending_payments_organisation_id_fkey"
            columns: ["organisation_id"]
            isOneToOne: false
            referencedRelation: "organisation"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "paystack_pending_payments_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "region"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "paystack_pending_payments_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "partner"
            referencedColumns: ["id"]
